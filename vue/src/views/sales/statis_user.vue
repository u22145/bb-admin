    ...
    <div class="whiteBg">
      <div class="tableCon">
        ...
        >
          ...
          <el-table-column label='注冊時間' align="center" prop="join_date"></el-table-column>
          <el-table-column label='是否激活' align="center" prop="active"></el-table-column>
          <el-table-column label='充值金額' align="center" prop="deposit_total"></el-table-column>
          <el-table-column label='賬戶餘額' align="center" prop="balance"></el-table-column>
          <el-table-column label='操作' align="center" min-width="130px" class-name="operation">
            <template slot-scope="scope">
              <el-button type="primary" @click="goUrl1(scope.row.id)">消費明細</el-button>
              <el-button type="primary" @click="goUrl(scope.row.id)">充值明細</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
