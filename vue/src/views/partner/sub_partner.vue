<template>
    <div class="vipcollocation">
        <div class="whiteBg">
            <div class="screen">
                <el-input clearable style="width: 200px" v-model="search_info" placeholder="输入ID或名称"></el-input>
                <el-button
                        type="primary"
                        class="fr"
        ...
        <el-dialog :visible.sync="dialogFormVisible">
            <el-form :model="form">
                ...
                <el-form-item label="上级ID" :label-width="formLabelWidth">
                    <el-input v-if="form.id" v-model="form.pid" disabled type="text"
                ...
                <el-form-item label="分成比例" :label-width="formLabelWidth">
                    <el-input v-model="form.share_rate" type="text" autocomplete="off"></el-input>
                </el-form-item>
