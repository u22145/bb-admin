    ...
    <div class="whiteBg">
      <div class="tableCon">
        ...
        >
          ...
          <el-table-column label='消費類別' align="center" prop="cate"></el-table-column>
          <el-table-column label='消費ID' align="center" prop="call_id"></el-table-column>
          <el-table-column label='消費金額' align="center" prop="fee"></el-table-column>
          <el-table-column label='消費時間' align="center" prop="uptime"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData(exp = 1) {
      this.loading = true;
      this.$http
        .post("/sales/sales_statis_expend", {
