    ...
    <div class="whiteBg">
      ...
      <div class="tableCon">
        ...
        >
          ...
          <el-table-column :label='$t("money.Seller_account")' align="center" prop="account"></el-table-column>
          ...
          <el-table-column :label='$t("money.Buyer_account")' align="center" prop="sell_uid"></el-table-column>
         ...
         <template slot-scope="scope">
          ...
          <el-table-column :label='$t("money.transactiontime")' align="center" prop="order_time" min-width="130"></el-table-column>
          <el-table-column :label='$t("common.operation")' align="center" min-width="130px" class-name="operation">
            <template slot-scope="scope">
              ...
              >{{$t("money.Transactionconfirmation")}}</el-button>
