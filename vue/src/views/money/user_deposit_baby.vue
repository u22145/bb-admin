<template>
  <div class="realnamelist">
    ...
    <div class="whiteBg">
      <div>
        <div style="background-color: #33ccff; width: 300px; margin: 10px; text-align: center; padding: 24px; line-height: 20px; float: left; color: #fff;">充幣人次(日 / 總)<br />{{this.sumary.user_day_deposit}} / {{this.sumary.user_all_deposit}}</div>
        <div style="background-color: #0099ff; width: 300px; margin: 10px; text-align: center; padding: 24px; line-height: 20px; float: left; color: #fff;">充幣數量(日 / 總)<br />{{this.sumary.user_day_amount}} / {{this.sumary.user_all_amount}}</div>
      </div>
      ...
      <div class="tableCon">
        ...
        >
          ...
          <el-table-column label='充值來源地址' align="center" prop="from_addr"></el-table-column>
          <el-table-column label='充幣數量' align="center" prop="amount"></el-table-column>
          <el-table-column label='餘額' align="center" prop="balance"></el-table-column>
          <el-table-column label='創建時間' align="center" prop="uptime"></el-table-column>
