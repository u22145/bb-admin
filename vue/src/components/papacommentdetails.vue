<template>
  <div class="papacommentdetails">
    ...
    >
      <div>
        <!-- 头部 -->
        <div class="conTitle">{{$t("commentlist.conTitle6")}}</div>
        <el-button
        ...
        <div class="detailed">
          <div class="essentialInformation">
            ...
            <!-- <div class="screen clear">
                <el-button type="danger" class="fr" style="padding: 8px 30px">屏蔽</el-button>
                <el-button type="primary" class="fr" style="padding: 8px 30px">通过</el-button>
            </div>-->
          </div>
        </div>
      </div>
