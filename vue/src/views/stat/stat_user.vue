  ...
  <div class="realnamelist">
    ...
    <div class="whiteBg">
      <div>
        ...
        <div style="background-color: #99cc66; width: 200px; margin: 10px; text-align: center; padding: 24px; line-height: 20px; float: left; color: #fff;">充值縂金額<br />{{sumary.dep1}}</div>
        <div style="background-color: #0099ff; width: 200px; margin: 10px; text-align: center; padding: 24px; line-height: 20px; float: left; color: #fff;">總日活用戶數<br />{{sumary.online}}</div>
      </div>
      <!--<div class="fr">
      ...
      <div class="tableCon">
        ...
        >
          ...
          <el-table-column label='日活' align="center" prop="online"></el-table-column>
          <el-table-column label='次日留存率' align="center" prop="online_rate"></el-table-column>
